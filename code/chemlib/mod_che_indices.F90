...
!    now declared in mod_runparam for surface/chem  interface compatibility !!
  ...
  integer(ik4) :: iaor1 , iaor2 , iaor3 , iaor4 , ibor1 , ibor2 ,       &
                  ibor3 , ibor4 , iisoa1, iisoa2, iisoa3, iisoa4  !ycq2013
  integer(ik4) :: igaor1 , igaor2 , igaor3 , igaor4 , igbor1 , & !ycq2013
                  igbor2 , igbor3 , igbor4 , igiso1 , igiso2 , &
                  igiso3 , igiso4
  integer(ik4) :: iapin , ilimo , igout   !ycq2013
  integer(ik4) :: imsa
...
! integer(ik4) :: ianh4, iano3 : now declared in mod_runparam
  ...
  integer(ik4) , parameter :: ind_gout   = 59          !ycq2013
  integer(ik4) , parameter :: ind_gaor1  = 60
  integer(ik4) , parameter :: ind_gaor2  = 61
  integer(ik4) , parameter :: ind_gaor3  = 62
  integer(ik4) , parameter :: ind_gaor4  = 63
  integer(ik4) , parameter :: ind_gbor1  = 64
  integer(ik4) , parameter :: ind_gbor2  = 65
  integer(ik4) , parameter :: ind_gbor3  = 66
  integer(ik4) , parameter :: ind_gbor4  = 67
  integer(ik4) , parameter :: ind_giso1  = 68
  integer(ik4) , parameter :: ind_giso2  = 69
  integer(ik4) , parameter :: ind_giso3  = 70
  integer(ik4) , parameter :: ind_giso4  = 71
  ! indices for jvalues
