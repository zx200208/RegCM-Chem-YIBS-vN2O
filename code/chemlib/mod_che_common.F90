...
module mod_che_common
  ...
  integer(ik4) , parameter :: maxntr = 51
  ...
  real(rk8) , pointer , dimension(:,:) :: co2emission, yco2flux  !!! xiaoxie 2017
  real(rk8) , pointer , dimension(:,:) :: n2oemission !!! zhangq 2023
...
real(rkx) , pointer , dimension(:,:,:) :: asca3d ,aod3d !dyma 2021
  ...
  subroutine allocate_mod_che_common(isladvec)
    ...
    if ( ichem == 1 ) then
      ...
      call getmem2d(co2emission,jce1,jce2,ice1,ice2,'che_common:co2emission') !!! xiaoxie 2017	
      call getmem2d(yco2flux,jci1,jci2,ici1,ici2,'che_common:yco2flux') !!! xiaoxie 2017
      call getmem2d(n2oemission,jce1,jce2,ice1,ice2,'che_common:n2oemission') !!! zhangq 2023	  
      ...
      call getmem1d(icarb,1,15,'mod_che_common:icarb') !!!! xiaoxie careful modified from 7 to 15 (7 org @ 8 SOA)
  ...
  subroutine chem_config
    ...
    if ( chemsimtype(1:4) == 'DUST' ) then
      ...
      ntr = 3 !!! xie 2-->3
      allocate(chtrname(ntr))
      chtrname(1:ntr)(1:6) = (/'SO2   ','SO4   ','CO2   '/) !!! xie
      iaerosol = 1
      ioxclim  = 1
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@!
   ! xiaoxie modified
      ...
      chtrname(1:ntr)(1:6) = (/'NO    ','NO2   ','N2O5  ','HNO2  ',&
                               ...
                               'ANO3  ','ANH4  ','TERP  ','AOR1  ',&
                               'AOR2  ','AOR3  ','AOR4  ','BOR1  ',&
                               'BOR2  ','BOR3  ','BOR4  ','GAOR1 ',&
                               'GAOR2 ','GAOR3 ','GAOR4 ','GBOR1 ',&
                               'GBOR2 ','GBOR3 ','GBOR4 '/) !!!zhangq add OH 
      iaerosol = 1
      igaschem = 1
      iisoropia = 1
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@!
      ...
      ntr = 39 !!! xiaoxie 2017 /// 37-->38 !!! zhangq 38-->39 
      allocate(chtrname(ntr))
      chtrname(1:ntr)(1:6) = (/'NO    ','NO2   ','N2O5  ','HNO2  ',&
                               'HNO3  ','HNO4  ','O3    ','H2O2  ',&
                               'CO    ','SO2   ','DMS   ','H2SO4 ',&
    ...
    else if ( chemsimtype(1:3) == 'CO2' ) then
      ntr = 1
      allocate(chtrname(ntr))
      chtrname(1:ntr)(1:6) = (/'CO2   ' /)
      iaerosol = 1
      if ( myid == italk ) write(stdout,*) 'CO2 simulation'      
    else
      if ( myid == italk ) then
