...
!
  ...
  integer(ik4) , parameter :: nsrf3dvars = 31 !!! xiaoxie 6 -> 16
  integer(ik4) , parameter :: nsrfvars = nsrf2dvars+nsrf3dvars

  integer(ik4) , parameter :: nsrfyibs2dvars = 5 + nbase
!  integer(ik4) , parameter :: nsrfyibs3dvars = 5 !!! xiaoxie 6 -> 16
  integer(ik4) , parameter :: nsrfyibsvars = nsrfyibs2dvars !+nsrfyibs3dvars
  ...
  type(ncvariable2d_real) , save , pointer , &
    dimension(:) :: v2dvar_srfyibs => null()   !!! xiaoxie
 ! type(ncvariable3d_real) , save , pointer , &
 !   dimension(:) :: v3dvar_srfyibs => null()   !!! xiaoxie     
  type(ncvariable2d_real) , save , pointer , &
  ...
  integer(ik4) , public :: srfyibs_stream = -1
...
!
  ...
  logical , public , dimension(nsrfyibsvars) :: enable_srfyibs_vars
  ...
  integer(ik4) , parameter :: srf_co2flux  = 30  !!! xiaoxie added
  integer(ik4) , parameter :: srf_npp      = 31
  integer(ik4) , parameter :: srf_gpp      = 32
  integer(ik4) , parameter :: srf_rauto    = 33
  integer(ik4) , parameter :: srf_lai      = 34
  integer(ik4) , parameter :: srf_TairC    = 35
  integer(ik4) , parameter :: srf_TcanopyC = 36
  integer(ik4) , parameter :: srf_Qf       = 37
  integer(ik4) , parameter :: srf_P_mbar   = 38
  integer(ik4) , parameter :: srf_Ca       = 39
  integer(ik4) , parameter :: srf_yCh      = 40
  integer(ik4) , parameter :: srf_U        = 41
  integer(ik4) , parameter :: srf_IPARdir  = 42
  integer(ik4) , parameter :: srf_IPARdif  = 43
  integer(ik4) , parameter :: srf_o3c      = 44
  
  integer(ik4) , parameter :: srf_elev     = 45
  integer(ik4) , parameter :: srf_inlat     = 46
  integer(ik4) , parameter :: srf_plant    = 47
  integer(ik4) , parameter :: srf_harvest  = 48
  integer(ik4) , parameter :: srf_swd   = 49
  integer(ik4) , parameter :: srf_swf   = 50
 

  integer(ik4) , parameter :: srfyibs_xlon     = 1
  integer(ik4) , parameter :: srfyibs_xlat     = 2
  integer(ik4) , parameter :: srfyibs_mask     = 3
  integer(ik4) , parameter :: srfyibs_topo     = 4
  integer(ik4) , parameter :: srfyibs_ps       = 5
  integer(ik4) , parameter :: srfyibs_co2flux  = 6  !!! xiaoxie added
  integer(ik4) , parameter :: srfyibs_npp      = 7
  integer(ik4) , parameter :: srfyibs_gpp      = 8
  integer(ik4) , parameter :: srfyibs_rauto    = 9
  integer(ik4) , parameter :: srfyibs_lai      = 10
  ...
  integer(ik4) , parameter :: srf_stm    = 7  !!! xiaoxie added 
  integer(ik4) , parameter :: srf_smp    = 8
  integer(ik4) , parameter :: srf_sif    = 9
  integer(ik4) , parameter :: srf_tcn    = 10
  integer(ik4) , parameter :: srf_qcn    = 11
  integer(ik4) , parameter :: srf_ch     = 12
  integer(ik4) , parameter :: srf_pard   = 13
  integer(ik4) , parameter :: srf_parf   = 14
  integer(ik4) , parameter :: srf_fwt    = 15
  integer(ik4) , parameter :: srf_cosz   = 16
  integer(ik4) , parameter :: srf_sq     = 17
  integer(ik4) , parameter :: srf_soilt  = 18
  integer(ik4) , parameter :: srf_soilm  = 19
  integer(ik4) , parameter :: srf_soilp  = 20
  integer(ik4) , parameter :: srf_soili  = 21
  
  integer(ik4) , parameter :: srf_inveg       = 22
  integer(ik4) , parameter :: srf_inpop       = 23
  integer(ik4) , parameter :: srf_inh         = 24 
  integer(ik4) , parameter :: srf_indbh       = 25
  integer(ik4) , parameter :: srf_incrad      = 26
  integer(ik4) , parameter :: srf_intexture   = 27
  integer(ik4) , parameter :: srf_inlai       = 28
  integer(ik4) , parameter :: srf_inalbedo    = 29
  integer(ik4) , parameter :: srf_incpool     = 30
  integer(ik4) , parameter :: srf_intpool     = 31
  ...
  subroutine init_output_streams(lparallel)
    ...
    logical , dimension(nsrfyibs2dvars) :: enable_srfyibs2d_vars !!! xiaoxie
 !   logical , dimension(nsrfyibs3dvars) :: enable_srfyibs3d_vars !!! xiaoxie    
    ...
    do nstream = 1 , maxstreams
     ...
     if ( nstream == srfyibs_stream ) then
        enable_srfyibs_vars(:) = .true.
        allocate(v2dvar_srfyibs(nsrfyibs2dvars))
       ! allocate(v3dvar_srfyibs(nsrfyibs3dvars))
        enable_srfyibs2d_vars = enable_srfyibs_vars(1:nsrfyibs2dvars)
       ! enable_srfyibs3d_vars = enable_srfyibs_vars(nsrfyibs2dvars+1:nsrfyibsvars)

        ! This variables are always present

        call setup_common_vars(vsize,v2dvar_srfyibs,srfyibs_xlon, &
                  srfyibs_xlat,srfyibs_topo,srfyibs_mask,srfyibs_ps,-1)

        ! The following may be enabled/disabled

        if ( enable_srfyibs2d_vars(srfyibs_co2flux) ) then
          call setup_var(v2dvar_srfyibs,srfyibs_co2flux,vsize,&
        'co2flux','kg[C]/m2/s', &
            'CO2 flux','co2_flux',.true.,'time: mean', &
            l_fill=.true.)
          srfyibs_co2flux_out => v2dvar_srfyibs(srfyibs_co2flux)%rval
        end if
        if ( enable_srfyibs2d_vars(srfyibs_npp) ) then
          call setup_var(v2dvar_srfyibs,srfyibs_npp,vsize,'npp','kg[C]/m2/s', &
            'NPP','npp',.true.,'time: mean', &
            l_fill=.true.)
          srfyibs_npp_out => v2dvar_srfyibs(srfyibs_npp)%rval
        end if
        if ( enable_srfyibs2d_vars(srfyibs_gpp) ) then
          call setup_var(v2dvar_srfyibs,srfyibs_gpp,vsize,'gpp','kg[C]/m2/s', &
            'GPP','gpp',.true.,'time: mean', &
            l_fill=.true.)
          srfyibs_gpp_out => v2dvar_srfyibs(srfyibs_gpp)%rval
        end if
        if ( enable_srfyibs2d_vars(srfyibs_rauto) ) then
          call setup_var(v2dvar_srfyibs,srfyibs_rauto,vsize,&
        'rauto','kg[C]/m2/s', &
            'respiration','respiration',.true.,'time: mean', &
            l_fill=.true.)
          srfyibs_rauto_out => v2dvar_srfyibs(srfyibs_rauto)%rval
        end if
        if ( enable_srfyibs2d_vars(srfyibs_lai) ) then
          call setup_var(v2dvar_srfyibs,srfyibs_lai,vsize,'lai','m2 m-2', &
            'LAI','lai',.true.,'time: mean', &
            l_fill=.true.)
          srfyibs_lai_out => v2dvar_srfyibs(srfyibs_lai)%rval
        end if

    
        enable_srfyibs_vars(1:nsrfyibs2dvars) = enable_srfyibs2d_vars
       ! enable_srfyibs_vars(nsrfyibs2dvars+1:nsrfyibsvars) = enable_srfyibs3d_vars
        outstream(srfyibs_stream)%nvar = countvars(enable_srfyibs_vars,nsrfyibsvars)
        allocate(outstream(srfyibs_stream)%ncvars%vlist(outstream(srfyibs_stream)%nvar))
        outstream(srfyibs_stream)%nfiles = 1
        allocate(outstream(srfyibs_stream)%ncout(outstream(srfyibs_stream)%nfiles))
        allocate(outstream(srfyibs_stream)%cname_base(outstream(srfyibs_stream)%nfiles))
        outstream(srfyibs_stream)%cname_base(1) = 'srfyibs'

        vcount = 1
        do i = 1 , nsrfyibs2dvars
          if ( enable_srfyibs_vars(i) ) then
            outstream(srfyibs_stream)%ncvars%vlist(vcount)%vp => v2dvar_srfyibs(i)
            vcount = vcount + 1
          end if
        end do
        !do i = 1 , nsrfyibs3dvars
        !  if ( enable_srfyibs_vars(i+nsrfyibs2dvars) ) then
        !    outstream(srfyibs_stream)%ncvars%vlist(vcount)%vp => v3dvar_srfyibs(i)
        !    vcount = vcount + 1
        !  end if
        !end do
        outstream(srfyibs_stream)%jl1 = vsize%j1
        outstream(srfyibs_stream)%jl2 = vsize%j2
        outstream(srfyibs_stream)%il1 = vsize%i1
        outstream(srfyibs_stream)%il2 = vsize%i2
        outstream(srfyibs_stream)%jg1 = jout1
        outstream(srfyibs_stream)%jg2 = jout2
        outstream(srfyibs_stream)%ig1 = iout1
        outstream(srfyibs_stream)%ig2 = iout2
      end if
      ...
      if ( nstream == srf_stream ) then
        ...
        if ( enable_srf2d_vars(srf_trunoff) ) then
          call setup_var(v2dvar_srf,srf_trunoff,vsize,&
		    'mrro','kg m-2 s-1', &
        ...
        if ( enable_srf2d_vars(srf_co2flux) ) then
          call setup_var(v2dvar_srf,srf_co2flux,vsize,&
		    'co2flux','kg[C]/m2/s', &
            'CO2 flux','co2_flux',.true.,'time: mean', &
            l_fill=.true.)
          srf_co2flux_out => v2dvar_srf(srf_co2flux)%rval
        end if
        if ( enable_srf2d_vars(srf_npp) ) then
          call setup_var(v2dvar_srf,srf_npp,vsize,'npp','kg[C]/m2/s', &
            'NPP','npp',.true.,'time: mean', &
            l_fill=.true.)
          srf_npp_out => v2dvar_srf(srf_npp)%rval
        end if
        if ( enable_srf2d_vars(srf_gpp) ) then
          call setup_var(v2dvar_srf,srf_gpp,vsize,'gpp','kg[C]/m2/s', &
            'GPP','gpp',.true.,'time: mean', &
            l_fill=.true.)
          srf_gpp_out => v2dvar_srf(srf_gpp)%rval
        end if
        if ( enable_srf2d_vars(srf_rauto) ) then
          call setup_var(v2dvar_srf,srf_rauto,vsize,&
		    'rauto','kg[C]/m2/s', &
            'respiration','respiration',.true.,'time: mean', &
            l_fill=.true.)
          srf_rauto_out => v2dvar_srf(srf_rauto)%rval
        end if
        if ( enable_srf2d_vars(srf_lai) ) then
          call setup_var(v2dvar_srf,srf_lai,vsize,'lai','m2 m-2', &
            'LAI','lai',.true.,'time: mean', &
            l_fill=.true.)
          srf_lai_out => v2dvar_srf(srf_lai)%rval
        end if

        enable_srf2d_vars(35:48) = .false.  !!!! xie disable some outputs
        if ( enable_srf2d_vars(srf_TairC) ) then
          call setup_var(v2dvar_srf,srf_TairC,vsize,&
		    'TairC','C', &
            'AIR Temperature','AIR_TEMPERATURE',.true.,'time: mean', &
            l_fill=.true.)
          srf_TairC_out => v2dvar_srf(srf_TairC)%rval
        end if
        if ( enable_srf2d_vars(srf_Qf) ) then
          call setup_var(v2dvar_srf,srf_Qf,vsize,'Qf','kg/KG', &
            'CANOPY AIR Humidity','CAN_HUMIDITY',.true.,'time: mean', &
            l_fill=.true.)
          srf_Qf_out => v2dvar_srf(srf_Qf)%rval
        end if
        if ( enable_srf2d_vars(srf_P_mbar) ) then
          call setup_var(v2dvar_srf,srf_P_mbar,vsize,&
		    'Pmar','HPA', &
            'Surface Pressure','SRF_P',.true.,'time: mean', &
            l_fill=.true.)
          srf_P_mbar_out => v2dvar_srf(srf_P_mbar)%rval
        end if
        if ( enable_srf2d_vars(srf_Ca) ) then
          call setup_var(v2dvar_srf,srf_Ca,vsize,'Ca','MOL/M3', &
            'CO2 AT SURFACE HEIGHT','SURFACE_CO2',.true.,'time: mean', &
            l_fill=.true.)
          srf_Ca_out => v2dvar_srf(srf_Ca)%rval
        end if
        if ( enable_srf2d_vars(srf_yCh) ) then
          call setup_var(v2dvar_srf,srf_yCh,vsize,'yCh','UMOL/M2/S', &
            'Boundary conductance','BDY_CONDUCTANCE',.true.,'time: mean', &
            l_fill=.true.)
          srf_yCh_out => v2dvar_srf(srf_yCh)%rval
        end if
        if ( enable_srf2d_vars(srf_U) ) then
          call setup_var(v2dvar_srf,srf_U,vsize,'U','m/s', &
            'SURFACE WIND','WIND',.true.,'time: mean', &
            l_fill=.true.)
          srf_U_out => v2dvar_srf(srf_U)%rval
        end if
        if ( enable_srf2d_vars(srf_IPARdir) ) then
          call setup_var(v2dvar_srf,srf_IPARdir,vsize,&
		    'pardir','W/m2', &
            'PAR DIR','DIR_PAR',.true.,'time: mean', &
            l_fill=.true.)
          srf_IPARdir_out => v2dvar_srf(srf_IPARdir)%rval
        end if
        if ( enable_srf2d_vars(srf_IPARdif) ) then
          call setup_var(v2dvar_srf,srf_IPARdif,vsize,&
		    'pardif','W/m2', &
            'PAR DIF','DIF_PAR',.true.,'time: mean', &
            l_fill=.true.)
          srf_IPARdif_out => v2dvar_srf(srf_IPARdif)%rval
        end if
        if ( enable_srf2d_vars(srf_swd) ) then
          call setup_var(v2dvar_srf,srf_swd,vsize,'SWD','W m-2', &
            'Direct solar radiation at surface', &
            'direct_sw',.true.,'time: mean',l_fill=.true.)
          srf_swd_out => v2dvar_srf(srf_swd)%rval
        end if
        if ( enable_srf2d_vars(srf_swf) ) then
          call setup_var(v2dvar_srf,srf_swf,vsize,'SWF','1', &
            'Diffuse solar radiation at surface' , &
            'diffuse_sw',.true.,'time: mean',l_fill=.true.)
          srf_swf_out => v2dvar_srf(srf_swf)%rval
        end if
        if ( enable_srf2d_vars(srf_o3c) ) then
          call setup_var(v2dvar_srf,srf_o3c,vsize,&
		    'o3c','NMOL/M3', &
            'SURFACE O3','O3',.true.,'time: mean', &
            l_fill=.true.)
          srf_o3c_out => v2dvar_srf(srf_o3c)%rval
        end if
        if ( enable_srf2d_vars(srf_TcanopyC) ) then
          call setup_var(v2dvar_srf,srf_TcanopyC,vsize,&
		    'TcanopyC','C', &
            'CANOPY Temperature','Canopy_T',.true.,'time: mean', &
            l_fill=.true.)
          srf_TcanopyC_out => v2dvar_srf(srf_TcanopyC)%rval
        end if

        if ( enable_srf2d_vars(srf_elev) ) then
          call setup_var(v2dvar_srf,srf_elev,vsize,&
		    'elev','m', &
            'input elev','in_elev',.true.,'time: mean', &
            l_fill=.true.)
          srf_elev_out => v2dvar_srf(srf_elev)%rval
        end if
        if ( enable_srf2d_vars(srf_inlat) ) then
          call setup_var(v2dvar_srf,srf_inlat,vsize,&
		    'inlat','degrees_north', &
            'input lat','in_lat',.true.,'time: mean', &
            l_fill=.true.)
          srf_inlat_out => v2dvar_srf(srf_inlat)%rval
        end if
        if ( enable_srf2d_vars(srf_plant) ) then
          call setup_var(v2dvar_srf,srf_plant,vsize,&
		    'plant','DAY', &
            'input plant date','in_plant_date',.true.,'time: mean', &
            l_fill=.true.)
          srf_plant_out => v2dvar_srf(srf_plant)%rval
        end if
        if ( enable_srf2d_vars(srf_harvest) ) then
          call setup_var(v2dvar_srf,srf_harvest,vsize,&
		    'harvest','DAY', &
            'input harvest date','in_harvest_date',.true.,'time: mean', &
            l_fill=.true.)
          srf_harvest_out => v2dvar_srf(srf_harvest)%rval
        end if
        ...
        v3dvar_srf(srf_tcn)%axis = 'xy2'  !!! xiaoxie added
        v3dvar_srf(srf_qcn)%axis = 'xy2'
        v3dvar_srf(srf_ch)%axis = 'xy2'
        v3dvar_srf(srf_pard)%axis = 'xy2'
        v3dvar_srf(srf_parf)%axis = 'xy2'
        v3dvar_srf(srf_fwt)%axis = 'xy2'
        v3dvar_srf(srf_cosz)%axis = 'xy2'
        v3dvar_srf(srf_swd)%axis = 'xy2'
        v3dvar_srf(srf_swf)%axis = 'xy2'
        ...
        if ( enable_srf3d_vars(srf_tcn) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_tcn,vsize,'taf','K', &
            'Canopy air temperature', &
            'canopy_temperature',.true.)
          srf_tcn_out => v3dvar_srf(srf_tcn)%rval
        end if
        if ( enable_srf3d_vars(srf_qcn) ) then
          call setup_var(v3dvar_srf,srf_qcn,vsize,'qaf','kg kg-1', &
            'Canopy air humidity' , &
            'canopy_humidity',.true.)
          srf_qcn_out => v3dvar_srf(srf_qcn)%rval
        end if
        if ( enable_srf3d_vars(srf_ch) ) then
          call setup_var(v3dvar_srf,srf_ch,vsize,'ch','1', &
            'Ground to surface heat transfer coefficient', &
			'heat_tranf_coef',.true.)
          srf_ch_out => v3dvar_srf(srf_ch)%rval
        end if
        if ( enable_srf3d_vars(srf_pard) ) then
          call setup_var(v3dvar_srf,srf_pard,vsize,'pard','W m-2', &
            'Incident dir PAR','dir_par',.true.)
          srf_pard_out => v3dvar_srf(srf_pard)%rval
        end if
        if ( enable_srf3d_vars(srf_parf) ) then
          call setup_var(v3dvar_srf,srf_parf,vsize,'parf','W m-2', &
            'Incident dif PAR','dif_par',.true.)
          srf_parf_out => v3dvar_srf(srf_parf)%rval
        end if
        if ( enable_srf3d_vars(srf_fwt) ) then
          call setup_var(v3dvar_srf,srf_fwt,vsize,'fwet','1', &
            'Fraction of wet canopy', &
            'wet_canopy',.true.)
          srf_fwt_out => v3dvar_srf(srf_fwt)%rval
        end if
        if ( enable_srf3d_vars(srf_cosz) ) then
          call setup_var(v3dvar_srf,srf_cosz,vsize,'cosz','1', &
            'Cos of solar zenith angle' , &
            'cos_z',.true.)
          srf_cosz_out => v3dvar_srf(srf_cosz)%rval
        end if

        vsize%k2 = num_soil_layers
        v3dvar_srf(srf_smw)%axis = 'xys'  !!! xiaoxie added 
        v3dvar_srf(srf_sq)%axis  = 'xys'
        v3dvar_srf(srf_stm)%axis = 'xys'
        v3dvar_srf(srf_smp)%axis = 'xys'
        v3dvar_srf(srf_sif)%axis = 'xys'
        v3dvar_srf(srf_soilt)%axis   = 'xys'
        v3dvar_srf(srf_soilm)%axis   = 'xys'
        v3dvar_srf(srf_soilp)%axis   = 'xys'
        v3dvar_srf(srf_soili)%axis   = 'xys'		
        ...
        if ( enable_srf3d_vars(srf_sq) ) then
          call setup_var(v3dvar_srf,srf_sq,vsize,'smq','kg kg-1', &
            'Moisture of the soil layers', &
            'soil_moisture_in_layers',.true.,l_fill=.true.)
          srf_sq_out => v3dvar_srf(srf_sq)%rval
        end if
        if ( enable_srf3d_vars(srf_stm) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_stm,vsize,'stmp','C', &
            'temperature of the soil layers', &
            'soil_temperature_in_layers',.true.,l_fill=.true.)
          srf_stm_out => v3dvar_srf(srf_stm)%rval
        end if
        if ( enable_srf3d_vars(srf_smp) ) then
          call setup_var(v3dvar_srf,srf_smp,vsize,'slmp','1', &
            'lmp of the soil layers', &
            'soil_matric_potential_in_layers',.true.,l_fill=.true.)
          srf_smp_out => v3dvar_srf(srf_smp)%rval
        end if
        if ( enable_srf3d_vars(srf_sif) ) then
          call setup_var(v3dvar_srf,srf_sif,vsize,'sifc','1', &
            'icefrac of the soil layers', &
            'soil_ice_fraction_in_layers',.true.,l_fill=.true.)
          srf_sif_out => v3dvar_srf(srf_sif)%rval
        end if
		
        enable_srf3d_vars(18:21) = .false.   !!!! xie disabale some outputs
        enable_srf3d_vars(27:31) = .true.
        if ( enable_srf3d_vars(srf_soilt) ) then
          call setup_var(v3dvar_srf,srf_soilt,vsize,'soilt','kg kg-1', &
            'temperature of the soil layers', &
            'soil_temperature_in_layers',.true.,l_fill=.true.)
          srf_soilt_out => v3dvar_srf(srf_soilt)%rval
        end if
        if ( enable_srf3d_vars(srf_soilm) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_soilm,vsize,'soilm','C', &
            'Moisture of the soil layers', &
            'soil_moisture_in_layers',.true.,l_fill=.true.)
          srf_soilm_out => v3dvar_srf(srf_soilm)%rval
        end if
        if ( enable_srf3d_vars(srf_soilp) ) then
          call setup_var(v3dvar_srf,srf_soilp,vsize,'soilp','1', &
            'lmp of the soil layers', &
            'soil_matric_potential_in_layers',.true.,l_fill=.true.)
          srf_soilp_out => v3dvar_srf(srf_soilp)%rval
        end if
        if ( enable_srf3d_vars(srf_soili) ) then
          call setup_var(v3dvar_srf,srf_soili,vsize,'soili','1', &
            'icefrac of the soil layers', &
            'soil_ice_fraction_in_layers',.true.,l_fill=.true.)
          srf_soili_out => v3dvar_srf(srf_soili)%rval
        end if
		
        vsize%k2 = kz
        v3dvar_srf(srf_inveg)%axis = 'xyz'  !!! xiaoxie added 
        v3dvar_srf(srf_inpop)%axis  = 'xyz'
        v3dvar_srf(srf_inh)%axis = 'xyz'
        v3dvar_srf(srf_indbh)%axis = 'xyz'  !!! xiaoxie added 
        v3dvar_srf(srf_incrad)%axis  = 'xyz'
        v3dvar_srf(srf_incpool)%axis = 'xyz'
        v3dvar_srf(srf_inalbedo)%axis = 'xyz'
        v3dvar_srf(srf_inlai)%axis = 'xyz'
        v3dvar_srf(srf_intpool)%axis = 'xyz'
        v3dvar_srf(srf_intexture)%axis = 'xyz'

        if ( enable_srf3d_vars(srf_intexture) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_intexture,vsize,'intext','1', &
            'input soil texture 1-5 available', &
            'in_text',.true.,l_fill=.true.)
          srf_intexture_out => v3dvar_srf(srf_intexture)%rval
        end if
        if ( enable_srf3d_vars(srf_intpool) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_intpool,vsize,'intpool','g/m2', &
            'input soil pools 1-16 available', &
            'in_tpool',.true.,l_fill=.true.)
          srf_intpool_out => v3dvar_srf(srf_intpool)%rval
        end if
        if ( enable_srf3d_vars(srf_inlai) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_inlai,vsize,'inlai','m2/m2', &
            'input lai', &
            'in_lai',.true.,l_fill=.true.)
          srf_inlai_out => v3dvar_srf(srf_inlai)%rval
        end if
        if ( enable_srf3d_vars(srf_inalbedo) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_inalbedo,vsize,'inalb','1', &
            'input albedo', &
            'in_alb',.true.,l_fill=.true.)
          srf_inalbedo_out => v3dvar_srf(srf_inalbedo)%rval
        end if			
        if ( enable_srf3d_vars(srf_indbh) ) then
          call setup_var(v3dvar_srf,srf_indbh,vsize,'indbh','m', &
            'input plant diameter', &
            'in_dbh',.true.,l_fill=.true.)
          srf_indbh_out => v3dvar_srf(srf_indbh)%rval
        end if
        if ( enable_srf3d_vars(srf_incrad) ) then
          call setup_var(v3dvar_srf,srf_incrad,vsize,'incrad','m', &
            'input crown dx', &
            'in_crad',.true.,l_fill=.true.)
          srf_incrad_out => v3dvar_srf(srf_incrad)%rval
        end if
        if ( enable_srf3d_vars(srf_incpool) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_incpool,vsize,'incpool','-', &
            'input C pool', &
            'in_cpool',.true.,l_fill=.true.)
          srf_incpool_out => v3dvar_srf(srf_incpool)%rval
        end if		
        if ( enable_srf3d_vars(srf_inveg) ) then
          call setup_var(v3dvar_srf,srf_inveg,vsize,'inveg','1', &
            'input veg fraction', &
            'in_veg',.true.,l_fill=.true.)
          srf_inveg_out => v3dvar_srf(srf_inveg)%rval
        end if
        if ( enable_srf3d_vars(srf_inpop) ) then
          call setup_var(v3dvar_srf,srf_inpop,vsize,'inpop','1', &
            'input population density', &
            'in_pop',.true.,l_fill=.true.)
          srf_inpop_out => v3dvar_srf(srf_inpop)%rval
        end if
        if ( enable_srf3d_vars(srf_inh) ) then                       !!! xiaoxie added
          call setup_var(v3dvar_srf,srf_inh,vsize,'inh','m', &
            'input veg height', &
            'in_h',.true.,l_fill=.true.)
          srf_inh_out => v3dvar_srf(srf_inh)%rval
        end if	
  ...
  subroutine newoutfiles(idate)
    ...
    do i = 1 , maxstreams
      ...
      do j = 1 , outstream(i)%nfiles
        ...
        do ivar = 1 , outstream(i)%nvar
          vp => outstream(i)%ncvars%vlist(ivar)%vp
          !print*,i,j,ivar,outstream(i)%cname_base(1),vp%vname,vp%standard_name,vp%vunit,vp%totsize
