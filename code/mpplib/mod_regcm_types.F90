...
!
  ...
  type lm_state
    ...
    real(rkx) , pointer , dimension(:,:,:,:) :: sw  !!! soil moist ?? xiaoxie 2017 guess
    real(rkx) , pointer , dimension(:,:,:,:) :: soilm  !!!  xiaoxie 2017 added soil temperature
    real(rkx) , pointer , dimension(:,:,:,:) :: sm  !!!  xiaoxie 2017 added soil temperature
    real(rkx) , pointer , dimension(:,:,:,:) :: ifrac  !!!  xiaoxie 2017 added soil temperature
    real(rkx) , pointer , dimension(:,:,:,:) :: smp  !!!  xiaoxie 2017 added soil temperature
    real(rkx) , pointer , dimension(:,:,:) :: ssw
    real(rkx) , pointer , dimension(:,:,:) :: rsw
    real(rkx) , pointer , dimension(:,:,:) :: tsw
    real(rkx) , pointer , dimension(:,:,:) :: tsoilm  !!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: tsm  !!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: tifrac  !!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: tsmp  !!! xiaoxie 2017
    ...
    real(rkx) , pointer , dimension(:,:,:) :: qaf	    !!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: fwet	    !!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: parsun_z	!!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: parsha_z	!!! xiaoxie 2017
    real(rkx) , pointer , dimension(:,:,:) :: gb_mol	!!! xiaoxie 2017	
...
#endif
!!!! xiaoxie 2017 added
    real(rkx) , pointer , dimension(:,:,:,:) :: vlai  
    real(rkx) , pointer , dimension(:,:,:)   :: vfrac
    real(rkx) , pointer , dimension(:,:,:)   :: vlandf
    real(rkx) , pointer , dimension(:,:,:)   :: vheight
    real(rkx) , pointer , dimension(:,:,:)   :: cpool
    real(rkx) , pointer , dimension(:,:,:)   :: vlaix
    real(rkx) , pointer , dimension(:,:,:)   :: frac_isl
    integer(rk4) , pointer , dimension(:,:)     :: mvegid
    real(rkx) , pointer , dimension(:,:)     :: vcrop
    real(rkx) , pointer , dimension(:,:,:)   :: crop_cal
    real(rkx) , pointer , dimension(:,:)     :: soil_c
    real(rkx) , pointer , dimension(:,:,:,:) :: clmlai  
    real(rkx) , pointer , dimension(:,:,:)   :: clmfrac
    real(rkx) , pointer , dimension(:,:,:)   :: clmhit
    real(rkx) , pointer , dimension(:,:,:)   :: stext

    real(rkx) , pointer , dimension(:,:,:,:) :: ystmp
    real(rkx) , pointer , dimension(:,:,:,:) :: ysmq
    real(rkx) , pointer , dimension(:,:,:,:) :: yslmp
    real(rkx) , pointer , dimension(:,:,:,:) :: ysifc
    real(rkx) , pointer , dimension(:,:,:)   :: ych
    real(rkx) , pointer , dimension(:,:,:)   :: ytaf
    real(rkx) , pointer , dimension(:,:,:)   :: yqaf
    real(rkx) , pointer , dimension(:,:,:)   :: ytas
    real(rkx) , pointer , dimension(:,:,:)   :: yuas
    real(rkx) , pointer , dimension(:,:,:)   :: yvas
    real(rkx) , pointer , dimension(:,:,:)   :: ypard
    real(rkx) , pointer , dimension(:,:,:)   :: yparf
    real(rkx) , pointer , dimension(:,:,:)   :: yfwet
    real(rkx) , pointer , dimension(:,:,:)   :: ycosz
!!!!
  end type lm_state
